package org.kurento.tutorial.one2manycall.utils;
...
public class EncodeUtil {
  ...
  public static void main(String[] args) {
    ...
    String content = "6162659&" + time.substring(0, time.length() - 3);
    String result = "f/bEpexzWABn69VIPDMd5I/n8TkiSEtyOitegIFCRPQ=";
//    System.out.println("根据输入的规则" + encodeRules + "加密后的密文是:" + result);

    //解密
    System.out.println("根据输入的规则" + encodeRules + "解密后的明文是:" + AESDncode(result));
  }
}
